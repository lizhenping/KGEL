...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.passage_ans_postion = nn.Linear(771,768)
        ...
        #50258 self.lm_head = nn.Linear(config.n_embd, config.vocab_size, bias=False)
        self.lm_head = nn.Linear(config.n_embd, 50258, bias=False)
    ...
    def forward(
        ...
        position_ids = cal_position_id_2(doc_state, batch.y1, batch.y2, context_mask)
        ...
        doc_state_temp = torch.cat((doc_state, position_embedded), dim=-1)
        doc_state_temp_1 = self.passage_ans_postion(doc_state_temp)
        doc_state = doc_state_temp_1
        ...
        #sequence_output[:, 0:384, :] = doc_state
